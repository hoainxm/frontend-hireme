...
import DataAnalyticsBackground from '../../common/ui/assets/images/Background1.png';
...
export const DASection: FC<Props> = (props) => {
  ...
  return (
    <SectionLayout id={sectionId} title='product.dataAnalytics' subTitle='product.dataAnalytics.subTitle' backgroundImage={DataAnalyticsBackground}>
